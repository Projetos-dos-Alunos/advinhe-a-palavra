...
function check() {
    // Obtém o valor inserido no campo de entrada com o ID "inputTextBox" e o converte para letras minúsculas.
    getresposta = document.getElementById("inputTextBox").value;
    resposta = getresposta.toLowerCase();

    // Verifica se a resposta é igual à variável "word".
    if (resposta == word) {
        // Se a resposta estiver correta, verifica de quem é o turno de resposta e atribui pontos ao jogador correspondente.
    ...
    // Alterna o turno de pergunta entre os jogadores e atualiza o texto correspondente na página.
    ...
    // Alterna o turno de resposta entre os jogadores e atualiza o texto correspondente na página.
    if (turnoDaResposta == "nomeJogador1") {
        turnoDaResposta = "nomeJogador2";
        document.getElementById("jogadorRespondendo").innerHTML = "Turno de Resposta - " + nomeJogador2;
    } else {
    ...
    // Limpa o conteúdo do elemento com o ID "output".
